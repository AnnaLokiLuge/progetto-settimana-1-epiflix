  ...
  return (
    <>
      <Navbar collapseOnSelect expand="lg"  variant="dark" className="myNavbar">
        <Navbar.Brand className="myNavbar"><img src={logo} id="logo"/></Navbar.Brand>
        ...
        <Navbar.Collapse id="responsive-navbar-nav"className="myNavbar">
          <Nav className="mr-auto myNavbar">
            ...
            <Nav.Link href="#" className="myNavbar " >Movies</Nav.Link>
            <Nav.Link href="#" className="myNavbar ">Recently Added</Nav.Link>
            <Nav.Link href="#" className="myNavbar ">My List</Nav.Link>
          </Nav>
          <Nav className="myNavbar ">
            <i className="fa fa-search icons myNavbar m-2"></i>
            <div id="kids" className="myNavbar m-2">KIDS</div>
